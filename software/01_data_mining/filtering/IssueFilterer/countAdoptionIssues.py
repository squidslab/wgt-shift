...
if __name__ == "__main__":
    # Path to the adoption_issues_filtered.json file
    ...
    file_path = os.path.join(workspace_root, 'resources', 'adoption_issues_filtered.json')
    
    # If not found, try relative to current working directory
    if not os.path.exists(file_path):
        file_path = os.path.join('resources', 'adoption_issues_filtered.json')
